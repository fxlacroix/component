...
use FXL\Component\Entity\Attached;
...
class QCM extends Attached
{
     ...
     * Add nodes
     *
     * @param \FXL\Component\Entity\Feature\Qcm\Node $nodes
     * @return QCM
     */
    public function addNode(\FXL\Component\Entity\Feature\Qcm\Node $nodes)
    {
        $this->nodes[] = $nodes;
     ...
     * @param \FXL\Component\Entity\Feature\Qcm\Node $nodes
     */
    public function removeNode(\FXL\Component\Entity\Feature\Qcm\Node $nodes)
    {
     ...
     * Add review
     *
     * @param \FXL\Component\Entity\Feature\Qcm\Reviews $reviews
     *
     * @return Review
     */
